...
import {getLanguageFlagPairFromLocale, SUPPORTED_LANGUAGES} from "../../i18n/I18nConfig";
                                    ...
                                    <MDBDropdown>
                                        ...
                                        <MDBDropdownMenu>
                                            <MDBDropdownItem> <MDBIcon icon="cog"/> <NavLink
                                                to={Routes.ACCOUNT}
                                                onClick={() => setOpen(false)}>{t('ns1:profileHeading')}</NavLink></MDBDropdownItem>
                                            <MDBDropdownItem><MDBIcon icon="sign-out-alt"/> <a
                                                onClick={() => {
                                                    props.onLogOut();
                                                    setOpen(false)
                                                }}>{t('ns1:logoutLabel')}</a></MDBDropdownItem>
                                        </MDBDropdownMenu>
                                    </MDBDropdown>
                                </MDBNavItem>
                            ) : (
